...
public class Shooter2Player extends GameEngine implements multigame.Game {
	//multigame variables
	...
	public Shooter2Player(MultiGame mg) {
		kh = mg.getKeyHandler();
	...
	public void gameRender(Graphics2D g) {
	    if (gameState.inState(gameState.READY)) {
	    	...
	    	g.setColor(Color.WHITE);
			g.setFont(new Font("TimesRoman", Font.PLAIN, (int)Shooter2Player.WINDOW_HEIGHT/10));
			...
			g.drawString("GAME OVER", (int)(Shooter2Player.WINDOW_WIDTH-width1)/2, (int)Shooter2Player.WINDOW_HEIGHT/3);
			//g.drawString("Final Score: " + player1.getScore(), (int)(Shooter2Player.WINDOW_WIDTH-width2)/2, (int)Shooter2Player.WINDOW_HEIGHT/3+height+20);
			//note: player 2 is left, player 1 is right, so their names get swapped here
			g.drawString("Player 1: " + player2.getScore() + " Player 2: " + player1.getScore(), (int)(Shooter2Player.WINDOW_WIDTH-width2)/2, (int)Shooter2Player.WINDOW_HEIGHT/3+height+20);
			g.drawString("High Score: " + save_data.getHighScore(), (int)(Shooter2Player.WINDOW_WIDTH-width3)/2, (int)Shooter2Player.WINDOW_HEIGHT/3+2*height+40);
			g.drawString("Press ESC to Exit", (int)(Shooter2Player.WINDOW_WIDTH-width4)/2, (int)Shooter2Player.WINDOW_HEIGHT/3+3*height+60);
	    }
	}
